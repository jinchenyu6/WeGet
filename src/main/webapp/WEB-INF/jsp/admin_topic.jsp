  ...
  <a href="/board/5">FIFA</a>
        ...
        <div class="layui-col-md9">
            <fieldset class="layui-elem-field">
                <div class="layui-field-box" style="min-height: 500px;background-color: white">
                    ...
                    <br/>
                    <blockquote class="layui-elem-quote layui-quote-nm">发表于：<fmt:formatDate value="${host.createTime}"
                                                                                            type="both"
                                                                                            dateStyle="medium"
                                                                                            timeStyle="medium"/>
    ...
    <c:forEach items="${pageInfo.list}" var="p">
        <div class="layui-row layui-col-space10" style="min-height: 300px">
            ...
            <div class="layui-col-md9">
                <fieldset class="layui-elem-field">
                    <div class="layui-field-box" style="min-height: 300px;background-color: white">
                        <blockquote class="layui-elem-quote layui-quote-nm">回复于：<fmt:formatDate value="${p.createTime}"
                                                                                                type="both"
                                                                                                dateStyle="medium"
                                                                                                timeStyle="medium"/></blockquote>
                        &nbsp;&nbsp; ${p.postText}
                        <form action="/deletePostByAdmin" method="post"
    ...
    <div style="float: right;height: 40px">
        ...
        <c:if test="${pageInfo.hasPreviousPage}">
            <a href="/article/${host.topicId}?page=${pageInfo.prePage}">上一页<i class="layui-icon layui-icon-prev"
                                                                              style="font-size: 15px; color: #39ac47;"></i></a>
        </c:if>
        &nbsp;
        <c:if test="${pageInfo.hasNextPage}">
            <a href="/article/${host.topicId}?page=${pageInfo.nextPage}">下一页<i class="layui-icon layui-icon-next"
                                                                               style="font-size: 15px; color: #39ac47;"></i></a>
        </c:if>
    </div>
