...
<div class="layui-container">
    ...
    <div class="layui-carousel" style=" margin: 0 auto;width: 100%" id="test1" lay-filter="test2">
        <div carousel-item="">
            <div><img src="/userPic/bcd38d1125e286b22f1179c605b47303.jpeg" onclick="window.open('https://lol.qq.com/');">
            </div>
            <div><img src="/userPic/7a2b08896b0a0868e2749244cba9adea.jpeg" onclick="window.open('https://cf.qq.com/');">
            </div>
            <div><img src="/userPic/159099401531618.jpg" onclick="window.open('https://pubg.qq.com/');"></div>
            <div><img src="/userPic/47a47bfe30821e806717665261d4d789.jpeg" onclick="window.open('https://lol.qq.com/');"></div>
            <div><img src="/userPic/e7134c772844b738503fab853db4dfb81586329298.jpg" onclick="window.open('https://games.wanmei.com/')"></div>
        </div>
    </div>
                    ...
                    <c:if test="${!empty user}">
                        <div class="layui-field-box" style="height: 300px">
                            <div style=" position: relative;text-align: center;  margin-bottom: 15px; border-radius: 2px; box-shadow: 0px 1px 2px 0px rgba(0,0,0,0.05);">
                                <img id="img" src="/userPic/pic.jpg" alt="aa"
                                     style="width: 130px;height: 130px;border-radius: 100%">
                                <br/>
                                <h1>${user.userName}</h1>
