            ...
            <div class="layui-tab-item layui-show">
                <table class="table table-hover">
                    ...
                    <c:forEach items="${list0}" var="list0">
                        <tr>
                            <td><a href="/admin_article/${list0.topicId}" style="color: #2b52a7">${list0.topicTitle}</a>&nbsp;&nbsp;
                            ...
                            <td>${list0.userName}
                                <br/>
                                <div style="font-size: 10px;color: gray">-<fmt:formatDate value="${list0.createTime}"
                                                                                          type="date"/></div>
                            </td>
                            <td>${list0.topicReplies}</td>
                            <td><fmt:formatDate value="${list0.lastPost}" type="both" dateStyle="medium"
                                                timeStyle="medium"/></td>
                            <td>
            ...
            <div class="layui-tab-item">
                <table class="table table-hover">
                    ...
                    <c:forEach items="${list1}" var="list1">
                        <tr>
                            <td><a href="/admin_article/${list1.topicId}" style="color: #2b52a7">${list1.topicTitle}</a>&nbsp;&nbsp;
                            ...
                            <td>${list1.userName}
                                <br/>
                                <div style="font-size: 10px;color: gray">-<fmt:formatDate value="${list1.createTime}"
                                                                                          type="date"/></div>
                            </td>
                            <td>${list1.topicReplies}</td>
                            <td><fmt:formatDate value="${list1.lastPost}" type="both" dateStyle="medium"
                                                timeStyle="medium"/></td>
                            <td>
                                <form action="/deleteArt" method="post">
                                    <input type="hidden" name="_method" value="DELETE">
            ...
            <div class="layui-tab-item">
                <table class="table table-hover">
                    ...
                    <c:forEach items="${list2}" var="list2">
                        <tr>
                            <td><a href="/admin_article/${list2.topicId}" style="color: #2b52a7">${list2.topicTitle}</a>&nbsp;&nbsp;
                            ...
                            <td>${list2.userName}
                                <br/>
                                <div style="font-size: 10px;color: gray">-<fmt:formatDate value="${list2.createTime}"
                                                                                          type="date"/></div>
                            </td>
                            <td>${list2.topicReplies}</td>
                            <td><fmt:formatDate value="${list2.lastPost}" type="both" dateStyle="medium"
                                                timeStyle="medium"/></td>
                            <td>
                                <form action="/deleteArt" method="post">
                                    <input type="hidden" name="_method" value="DELETE">
            ...
            <div class="layui-tab-item">
                <table class="table table-hover">
                    ...
                    <c:forEach items="${list3}" var="list3">
                        <tr>
                            <td><a href="/admin_article/${list3.topicId}" style="color: #2b52a7">${list3.topicTitle}</a>&nbsp;&nbsp;
                            ...
                            <td>${list3.userName}
                                <br/>
                                <div style="font-size: 10px;color: gray">-<fmt:formatDate value="${list3.createTime}"
                                                                                          type="date"/></div>
                            </td>
                            <td>${list3.topicReplies}</td>
                            <td><fmt:formatDate value="${list3.lastPost}" type="both" dateStyle="medium"
                                                timeStyle="medium"/></td>
                            <td>
                                <form action="/deleteArt" method="post">
                                    <input type="hidden" name="_method" value="DELETE">
            ...
            <div class="layui-tab-item">
                <table class="table table-hover">
                    ...
                    <c:forEach items="${list4}" var="list4">
                        <tr>
                            <td><a href="/admin_article/${list4.topicId}" style="color: #2b52a7">${list4.topicTitle}</a>&nbsp;&nbsp;
                            ...
                            <td>${list4.userName}
                                <br/>
                                <div style="font-size: 10px;color: gray">-<fmt:formatDate value="${list4.createTime}"
                                                                                          type="date"/></div>
                            </td>
                            <td>${list4.topicReplies}</td>
                            <td><fmt:formatDate value="${list4.lastPost}" type="both" dateStyle="medium"
                                                timeStyle="medium"/></td>
                            <td>
                                <form action="/deleteArt" method="post">
                                    <input type="hidden" name="_method" value="DELETE">
