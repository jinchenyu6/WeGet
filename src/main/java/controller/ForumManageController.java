...
public class ForumManageController {
    ...
    public String addTopicSuccess(@RequestParam int boardId, @RequestParam int subBoardId, @RequestParam String title, @RequestParam String text, @RequestParam int userId) {
        Topic topic = new Topic();
        topic.setTopicTitle(new EncodingTool().encodeStr(title));
        topic.setBoardId(boardId);
        topic.setSubBoardId(subBoardId);
