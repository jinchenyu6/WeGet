...
CREATE TABLE `t_peiwan`  (
  ...
  `peiwan_name` varchar(255) CHARACTER SET  utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `peiwan_password` varchar(255) CHARACTER SET  utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `peiwan_desc` varchar(255) CHARACTER SET  utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `t_right`  (
  ...
  `right_desc` varchar(255) CHARACTER SET  utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `t_superadmin`  (
  ...
  `superadmin_name` varchar(255) CHARACTER SET  utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `superadmin_password` varchar(255) CHARACTER SET  utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `right_id` int(11) DEFAULT NULL,
